...
public interface SyncRequest {
     ...
     */
    List<MarketPrecision> getAllMarkets( Integer offset, Integer limit);
...
//    List<TickerStatistics> get24HrPriceStatistics(String symbol, String quoteCurrency);
    ...
    List<TickerStatistics> getTickers( String symbols, String quoteTokenSymbol, QuoteTokenCategory quoteTokenCategory);
//    List<TickerStatistics> getTickersBySymbols(String symbols);
    /**
    ...
    /**
     * Check an order's detail.
     *
     * @param queryOrderRequest order status request options/filters
     * @return an order
     */
    Order getOrderDetail( QueryOrderRequest queryOrderRequest);
     ...
     */
    OrderList getAllOrders( QueryOrdersRequest orderRequest);
     ...
     * @param symbol
     */
    List<CancelOrderResponse> cancelOrders(String symbol);
