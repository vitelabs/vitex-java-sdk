...
public class UrlParamsBuilder {
    ...
    public UrlParamsBuilder putToUrl(String name, Byte value) {
        paramsMap.put(name, value);
        return this;
    }
    ...
    public String buildPostSignature() {
        Map<String, String> map = new TreeMap<>(postBodyMap.map);
        StringBuilder head = new StringBuilder();
        return AppendUrl(map, head);
    }
    ...
    class ParamsMap {
        ...
        void put(String name, Byte value) {
            put(name, value != null ? Byte.toString(value) : null);
        }
